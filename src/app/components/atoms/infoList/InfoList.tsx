    ...
    return (
        <>
            <div className={styles.il_ItemContainer}>
                ...
                <p className={styles.il_ItemContent}>Our modern web and mobile applications allow you to keep track of your finances wherever you are in the world.</p>
            </div>
            <div className={styles.il_ItemContainer}>
                ...
                <p className={styles.il_ItemContent}>See exactly where your money goes each month. Receive notifications when you`re close to hitting your limits.</p>
            </div>
            <div className={styles.il_ItemContainer}>
                ...
                <p className={styles.il_ItemContent}>We don`t do branches. Open your account in minutes online and start taking control of your finances right away.</p>
            </div>
            <div className={styles.il_ItemContainer}>
                <Image src={apiIcon} className={styles.il_ItemImage} alt='apiIcon'/>
                <p className={styles.il_ItemTitle}>Open API</p>
                <p className={styles.il_ItemContent}>Manage your savings, investments, pension, and much more from one account. Tracking your money has never been easier.</p>
            </div>
        </>
    )
}
